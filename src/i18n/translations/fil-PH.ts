...
export const filPH: TranslationTree = {
  ...
  home: {
    documentsTitle: 'Mga Dokumento at ID',
    documentsSubtitle: 'Tingnan at i-upload ang mga ID',
  ...
  auth: {
    ...
    signUpTagline: 'Gumawa ng account para simulan ang iyong gabay sa dokumento at ID.',
  ...
  documents: {
    ...
    steps: {
      intro:
        'Sundan ang tatlong hakbang na ito nang paisa-isa. Kumpletuhin ang isang seksyon para mabuksan ang susunod.',
      empty:
      ...
      incompleteRequirements: 'Tsekan muna ang lahat ng kinakailangan bago magpatuloy.',
      incompleteSteps: 'Tsekan muna ang lahat ng hakbang na natapos mo bago magpatuloy.',
      noPhotoTitle: 'Wala pang larawan',
      noPhotoMessage: 'Mag-upload muna ng kuha o larawan ng iyong dokumento bago tapusin.',
    },
    upload: {
      saveError: 'Hindi ma-save ang larawan',
      saveErrorBody: 'Pakisubukang muli. Siguraduhing may sapat na espasyo ang iyong device.',
      ...
      cameraPermission: 'Bigyan ng access sa camera ang Aidey para makakuha ng larawan.',
      photosPermission: 'Bigyan ng access sa photos ang Aidey para makapili ng larawan.',
  ...
  ai: {
    welcome: 'Kumusta!',
    welcomeText: 'Gabayan kita hakbang-hakbang sa dokumento o ID na kailangan mo.',
    placeholder: 'I-type ang tanong mo dito...',
    camera: 'Camera',
    uploadImage: 'Upload image',
    sendMessage: 'Send message',
    locationError: 'Hindi makuha ang lokasyon. Subukan muli o i-type ang iyong lungsod.',
    arrivalMessage: 'Narating ko na ang {{name}}. Malapit na ako sa opisina.',
    welcomeSuggestions: {
      philId: { label: 'Kumuha ng PhilID', value: 'Gusto kong kumuha ng PhilID / National ID.' },
      requirements: {
  ...
  maps: {
    ...
    errors: {
      enableRoutesApi: 'I-enable ang Routes API sa Google Cloud Console para sa ruta sa mapa.',
      enableBilling: 'Kailangan i-enable ang billing sa Google Cloud project para sa Google Maps.',
      useRoutesApi:
        'I-enable ang Routes API (hindi ang legacy Directions API) sa Google Cloud Console.',
      invalidApiKey: 'Hindi valid ang Google Maps API key o wala itong access sa Routes API.',
      loadRoute: 'Hindi ma-load ang ruta sa mapa.',
      noRoute: 'Walang nahanap na ruta mula sa iyong lokasyon papunta sa opisina.',
      missingApiKey: 'Idagdag ang EXPO_PUBLIC_GOOGLE_MAPS_API_KEY para sa ruta.',
    },
  },
  speech: {
    stopListening: 'Ihinto ang pakikinig',
    startListening: 'Speech to text ({{language}})',
    toggleHint: 'I-tap-and-hold para lumipat ng wika sa pagitan ng Filipino at English',
    micPermission: 'Kailangan ng pahintulot sa microphone para gumana ang speech-to-text.',
